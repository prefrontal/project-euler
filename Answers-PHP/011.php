...
$grid = array(
    ...
    array(24, 47, 32, 60, 99, 03, 45,  2, 44, 75, 33, 53, 78, 36, 84, 20, 35, 17, 12, 50),
    ...
    array(19, 80, 81, 68, 05, 94, 47, 69, 28, 73, 92, 13, 86, 52, 17, 77,  4, 89, 55, 40),
...
for ($j = 0; $j < 20; $j++) {
    for ($k = 0; $k < $numWindows; $k++) {
        $product = $grid[$k][$j] * $grid[$k+1][$j] * $grid[$k+2][$j] * $grid[$k+3][$j];
...
echo "The maximum product is: ", $maxProduct, "\n"
