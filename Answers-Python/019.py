...
print ("Total brute force count: ", BruteForceDayCount(1901, 2000, Weekday.TUESDAY, Weekday.SUNDAY))
print ("Total simple calculation count: ", SimpleDayCount(1901, 2000, Weekday.SUNDAY))
