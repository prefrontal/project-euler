...
for i in SMALLEST_TRIANGLE_SUM...MAXIMUM_VALUE
	solutionCount = 0
...
puts "The number of solutions is maximized at: #{maximumSolutionsAt}"
puts "The number of solutions was: #{maximumSolutionCount}"